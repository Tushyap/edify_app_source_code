...
function Footer() {
  return (
    <>
      <footer className="pt-3 pb-3 mt-auto">
        <div className="container">
          <div className="row">
            <div className="col-lg-3 my-3 text-center">
              ...
              <p>Changing Learning For The Better</p>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-12 col-lg-6">
              <ul className="list-unstyled list-inline d-flex justify-content-center justify-content-lg-end">
                <li className="list-inline-item">
                  <NavLink className="btn-floating btn-sm text-white" to="/">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
